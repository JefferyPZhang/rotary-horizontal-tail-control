# ChatGPT-generated Python plot script
...
# Output directory
OUTDIR = "C:/Users/xuz-t/OneDrive/Documents/Horizontal_Rotary_Tail/build/output"
os.makedirs(OUTDIR, exist_ok=True)

# Load data
rudderless = pd.read_csv(f"{OUTDIR}/rudderless_sim_history.csv", header=None)
ruddered   = pd.read_csv(f"{OUTDIR}/ruddered_sim_history.csv", header=None)
...
plt.suptitle("Navigation Coordinate Comparison (Stability Dynamics)")
...
fig1.savefig(f"{OUTDIR}/navigation_comparison.png", dpi=300)
plt.show()
...
fig3.savefig(f"{OUTDIR}/control_inputs_comparison.png", dpi=300)
plt.show()
